...
describe('Component: App', () => {
  ...
  it('should display the navigation bar correctly for guests', () => {
    ...
    expect(de[1].nativeElement.textContent).toContain('Admincards');
    expect(de[1].nativeElement.textContent).toContain('Mentors');
    ...
    expect(de[1].attributes['routerLink']).toBe('/admincards');
    expect(de[1].attributes['routerLink']).toBe('/mentors');
